public enum LocalizationKey
{
    ...
    Console_Parameter_Format_Split                     , // - {0}  ({1})
    ...
    Console_Desc_Set                                   , // 지정한 능력치의 현재값과 최대값을 동시에 설정합니다.
    ...
    Console_Desc_Item                                  , // 지정된 아이템을 생성, 제거(-r/-remove)하거나 인벤토리를 비웁니다.
    ...
    Console_Item_Usage                                 , // 사용법: item [이름/ID] [수량] [-r/-remove]
    Console_Item_InvalidID                             , // 유효하지 않은 아이템 ID 또는 키입니다: '{0}'.
    Console_Item_InventoryFull                         , // 인벤토리가 가득 차서 아이템을 소환할 수 없습니다.
    Console_Item_Success                               , // ([{0}] {1}) 아이템을 {2}개 소환했습니다.
    Console_Item_RemoveSuccess                         , // ([{0}] {1}) 아이템을 {2}개 제거했습니다.
    Console_Item_RemoveFailed                          , // 인벤토리에 제거할 아이템([{0}] {1})이 없거나 잘못되었습니다.
    ...
    Log_Inventory_Slot_DropFailed                      , // [UIInventorySlot] 장착 중인 아이템은 버릴 수 없습니다.
