public enum LocalizationKey
{
    ...
    UI_Option_Popup_Text_Fullscreen                    , // 창모드
    UI_Option_Popup_Text_Fullscreen_FullscreenWindow   , // 전체화면
    UI_Option_Popup_Text_Fullscreen_Windowed           , // 창모드
    UI_Option_Popup_Text_Fullscreen_ExclusiveFullscreen, // 테두리 없는 창모드
