public static class Log
{
    ...
    private static void Write<T1>(Localization key, LogType type, bool condition, T1 arg1)
    {
        if (!condition) 
            return;
    ...
    private static void Write<T1, T2>(Localization key, LogType type, bool condition, T1 arg1, T2 arg2)
    {
        if (!condition) 
            return;
    ...
    private static void Write<T1, T2, T3>(Localization key, LogType type, bool condition, T1 arg1, T2 arg2, T3 arg3)
    {
        if (!condition) 
            return;
